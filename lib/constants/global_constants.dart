...
class AppColors{
  static const Color primaryColor = Color(0xFFDBAD77);
  static const Color secondaryColor = Color(0xFFEBC69C);
  static const Color thirdColor = Color(0xFFFFE9CF);
  static const Color labelTextColor = Color(0xFF6B3C00);
}
